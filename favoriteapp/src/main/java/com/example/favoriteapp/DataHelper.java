...
public class DataHelper extends SQLiteOpenHelper {
    ...
    public static ArrayList<Movie> mapCursorToArrayList(Cursor movieCursor){
        ...
        while (movieCursor.moveToNext()){
            String judul = movieCursor.getString(movieCursor.getColumnIndexOrThrow(DatabaseContract.COLUMN_NAMA));
            String desc = movieCursor.getString(movieCursor.getColumnIndexOrThrow(DatabaseContract.COLUMN_DESC));
            String photo = movieCursor.getString(movieCursor.getColumnIndexOrThrow(DatabaseContract.COLUMN_PHOTO));
