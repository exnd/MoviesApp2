...
public class TVSearch extends AppCompatActivity implements RecyclerViewInterface {

    private RecyclerView rvMovies;
    private ArrayList<Movie> list = new ArrayList<>();
    private MainViewModel4 mainViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainViewModel = new ViewModelProvider(this, new ViewModelProvider.NewInstanceFactory()).get(MainViewModel4.class);
        ...
        if (searchManager != null) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextSubmit(String query) {
                    ...
                    Toast.makeText(TVSearch.this, query, Toast.LENGTH_SHORT).show();
                    return true;
                }
                @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.fav) {
            Intent mIntent = new Intent(TVSearch.this,Main2Activity.class);
            startActivity(mIntent);
        }

        if (item.getItemId() == R.id.moviesearch) {
            Intent mIntent = new Intent(TVSearch.this,MainActivity.class);
            startActivity(mIntent);
        }
