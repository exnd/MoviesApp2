...
public class MainViewModel4 extends ViewModel {
    ...
    void setWeather(String query) {
        ...
        if (Locale.getDefault().getLanguage().equals("in")){
            url = " https://api.themoviedb.org/3/search/tv?api_key=cedfdb517def7da8a93ba61da369b966&language=id&query="+query;


        }else{
            url = " https://api.themoviedb.org/3/search/tv?api_key=cedfdb517def7da8a93ba61da369b966&language=en-US&query="+query;
        }
