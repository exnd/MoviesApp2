...
public class MainViewModel extends ViewModel {
    ...
    void setWeather() {
        ...
        if (Locale.getDefault().getLanguage().equals("in")){
            url = "https://api.themoviedb.org/3/discover/movie?api_key=cedfdb517def7da8a93ba61da369b966&language=id";
        }else{
            url = "https://api.themoviedb.org/3/discover/movie?api_key=cedfdb517def7da8a93ba61da369b966&language=en-US";
        }
